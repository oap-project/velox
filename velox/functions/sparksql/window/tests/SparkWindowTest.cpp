...
// Tests nth_value without literal offsets.
TEST_P(SparkWindowTest, nthValueNonLiteralOffset) {
...
// Tests nth_value with invalid offset.
TEST_P(SparkWindowTest, nthValueInvalidOffsets) {
  vector_size_t size = 20;
