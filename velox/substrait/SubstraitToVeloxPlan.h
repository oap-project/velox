...
class SubstraitVeloxPlanConverter {
 public:
  ...
  core::PlanNodePtr toVeloxPlan(const ::substrait::ProjectRel& sProject);

  /// Used to convert Substrait FilterRel into Velox PlanNode.
  core::PlanNodePtr toVeloxPlan(const ::substrait::FilterRel& sFilter);
  ...
  core::PlanNodePtr toVeloxPlan(const ::substrait::Plan& sPlan);
